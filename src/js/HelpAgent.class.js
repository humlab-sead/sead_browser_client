...
class HelpAgent {
	...
	*/
	registerDefaultHelp() {
		this.hqs.tooltipManager.registerTooltip("#facet-menu-label", "SEAD contains a vast dataset, in order to view the data you need to filter it into a subsection. Choose your filters here.");
		this.hqs.tooltipManager.registerTooltip("#result-menu-label", "This lets you choose how to present the filtered subset of data. Result will be shown in the right section.");
		this.hqs.tooltipManager.registerTooltip("#result-container", "Here your filtered subset of data will be presented in the way you have choosen in the view menu.\nYou need to have activated at least one filter before anything will be shown here.\nAdd a filter via the filter menu on the top left and make a selection in the filter.");
	}
