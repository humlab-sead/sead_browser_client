...
class MosaicArchaeobotanyTaxaListModule extends MosaicTileModule {
    ...
    async render(renderIntoNode = null) {
        ...
        this.sqs.tooltipManager.registerTooltip(`#${varId} .mosaic-tile-title`, "Ranked list of the most frequently occurring archaeobotanical taxa across the selected sites.", { drawSymbol: true, anchorPoint: 'symbol' });
